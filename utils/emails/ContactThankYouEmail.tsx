...
export const ContactThankYouEmail = ({
    ...
    return (
        <Html>
            <Head />
            <Preview>Thank you for contacting MTech Distributors!</Preview>
            <Body style={main}>
                    ...
                    <Section style={box}>
                        <Section style={cardBody}>
                            ...
                            <Text style={paragraph}>
                                Thank you for reaching out to MTech Distributors! We've received your message and truly appreciate you taking the time to contact us.
                            </Text>

                            <Text style={paragraph}>
                                Our team is committed to providing exceptional service and support. We'll review your inquiry carefully and get back to you within 24 hours during business days.
                            </Text>

                            {/* Customer Info Card */}
                            <Section style={customerInfoCard}>
                                <Text style={sectionTitle}>Your Information</Text>
                                <div style={infoGrid}>
                                    <div style={infoItem}>
                            ...
                            <Section style={nextStepsCard}>
                                ...
                                <div style={stepContainer}>
                                    ...
                                    <div style={stepContent}>
                                        <Text style={stepTitle}>Review Your Message</Text>
                                        <Text style={stepDescription}>
                                            Our team will carefully review your inquiry and prepare a personalized response.
                                        </Text>
                                    </div>
                                </div>
                                ...
                                <div style={stepContainer}>
                                    ...
                                    <div style={stepContent}>
                                        <Text style={stepTitle}>Personal Response</Text>
                                        <Text style={stepDescription}>
                                            You'll receive a detailed response from one of our specialists within 24 hours.
                                        </Text>
                                    </div>
                                </div>
                                ...
                                <div style={stepContainer}>
                                    ...
                                    <div style={stepContent}>
                                        <Text style={stepTitle}>Follow-up Support</Text>
                                        <Text style={stepDescription}>
                                            We'll continue to assist you until your needs are fully addressed.
                                        </Text>
                                    </div>
                                </div>
                            </Section>
                            ...
                            <Text style={paragraph}>
                                In the meantime, feel free to explore our website to learn more about our products and services, or check out our FAQ section for quick answers to common questions.
                            </Text>
                            ...
                            {/* Response Time Card */}
                            <Section style={responseTimeCard}>
                                <Text style={sectionTitle}>Response Information</Text>
                                ...
                                <div style={priorityItem}>
                                    <div style={priorityIndicator}></div>
                                    <Text style={priorityText}>
                                        <strong>Next Steps:</strong> Check your email for our response
                                    </Text>
                                </div>
                            </Section>
                        </Section>
                    ...
                    <Section style={card}>
                        <Section style={cardBody}>
                            ...
                            <Text style={contactText}>
                                If you have urgent questions, you can reach us directly:
                            </Text>
                            <Text style={contactText}>
