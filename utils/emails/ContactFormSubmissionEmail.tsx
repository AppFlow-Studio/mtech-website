                ...
                <Container style={container}>
                        ...
                        <Section style={cardBody}>
                            ...
                            <Section style={detailsCard}>
                                ...
                                <div style={detailRow}>
                                    ...
                                    <Text style={detailValue} className='ml-2'>{submissionDate}</Text>
                                </div>

                                <div style={detailRow}>
                                    <Text style={detailLabel}>Source:</Text>
                                    <Text style={detailValue} className='ml-2'>Website Contact Form</Text>
                                </div>
                            </Section>
                            ...
                            <Section style={actionsCard}>
                                ...
                                <div style={buttonContainer}>
                                    <Button style={primaryButton} href={`mailto:${email}?subject=Re: Your inquiry to MTech Distributors`}>
                                        Reply via Email
                                    </Button>
                            ...
                            {/* <Section style={priorityCard}>
                                <Text style={sectionTitle}>Response Priority</Text>

                                <div style={priorityItem}>
                                    <div style={priorityIndicator}></div>
                                    <Text style={priorityText}>
                                        <strong>Standard Response Time:</strong> Within 24 hours
                                    </Text>
                                </div>
                                ...
                                <div style={priorityItem}>
                                    <div style={priorityIndicator}></div>
                                    <Text style={priorityText}>
                                        <strong>Follow-up Required:</strong> Yes - Customer expects response
                                    </Text>
                                </div>
                            </Section> */}
                        </Section>
                    ...
                    <Section style={footer}>
                        <Text style={footerText}>
                            This notification was automatically generated by the MTech Distributors website.
                        </Text>
                        <Text style={footerText}>
