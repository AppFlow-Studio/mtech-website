...
import { getOrderNotes } from "../actions/get-order-notes";
import { addOrderNote } from "../actions/add-order-note";
...
export default function OrderNotes({ orderId }: OrderNotesProps) {
    ...
    const addNoteMutation = useMutation({
        mutationFn: (note: string) => addOrderNote(orderId, profile?.id!, note, profile?.first_name + " " + profile?.last_name),
        onSuccess: () => {
