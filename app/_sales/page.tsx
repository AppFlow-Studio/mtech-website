...
import { useGetAgentById } from "../(master-admin)/master-admin/actions/AgentStore"
import AgentProductsTab from "../(master-admin)/master-admin/components/AgentProductsTab"
