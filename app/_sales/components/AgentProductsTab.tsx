...
import { useGetAgentById, useGetAgentProducts } from "../../(master-admin)/master-admin/actions/AgentStore"
const tags = [
    "atm parts",
    "pos parts",
    "network devices",
...
export default function AgentProductsTab({ agent_id }: { agent_id: string }) {
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Browse products available at your {agent.agent_tiers.name} pricing</p>
                </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {/* <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-sm font-medium text-green-600">
                                                    ${(agent_product.products.regularPrice - agent_product.products.tierPrice).toFixed(2)}
                                                </span>
                                            </div> */}
