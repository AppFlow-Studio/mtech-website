          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden xl:flex items-center space-x-4">
              ...
              {!user ? <Link href="/login" className="bg-gradient-to-b from-[#662CB2] to-[#2C134C] hover:from-[#7a35d1] hover:to-[#3c1963] text-white px-4 py-2 rounded-full transition-colors duration-200">
                Login
              </Link> : <Link href={profile?.role === "MASTER_ADMIN" ? "/master-admin" : profile?.role === "ADMIN" ? "/admin" : profile?.role === "AGENT" ? "/agent" : "/"} className="bg-gradient-to-b from-[#662CB2] to-[#2C134C] hover:from-[#7a35d1] hover:to-[#3c1963] text-white px-4 py-2 rounded-full transition-colors duration-200">
                Dashboard
              </Link>}
            </div>
